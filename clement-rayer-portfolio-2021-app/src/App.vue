<template>
  <div id="home-body">
    ...
    <div id="subtext">
        ...
        <a href="#">
            <img src="../public/down-arrow.svg" alt="Flèche vers le bas, lien pour la suite du contenu" id="down-arrow">
        </a>
    </div>
  </div>
</template>
...
#app {
    ...
    padding: 0;
    #home-body{
    background: radial-gradient(103.8% 103.8% at 50% 50%, #2562FF 0%, #FF4141 100%), #353131;
    height: 100vh;
